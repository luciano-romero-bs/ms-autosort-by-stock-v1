...
// Versión de la Admin API para tiendas nuevas y para las que no la traen
// seteada. Importa mantenerla al día: una versión vieja no ve las colecciones
// creadas con el modelo de datos del admin nuevo — no da error, directamente
// no existen para esa versión (ni en el listado, ni por id, ni en el conteo).
